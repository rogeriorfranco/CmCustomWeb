...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <section class="content-header">
        <h1>Alteração de Facilidades</h1>
    </section>
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class='row'>
                    ...
                    <div class="col-sm-1" id="dVlan" runat="server" visible="false">
                        <div class="form-group">
                            <label>Vlan</label>
                    ...
                    <div class="col-sm-1" id="dVlanVobb" runat="server">
                        <div class="form-group">
                            <label>Vobb</label>
                            <asp:TextBox ID="txtVlanVobb" runat="server" class="form-control input-sm" ClientIDMode="Static" ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
