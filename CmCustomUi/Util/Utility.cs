...
public static class Utility
{
    ...
    public static CoordenadasLatLong GetCoordenadasFromEndereco(string logradouro, string numero, string bairro, string cidade, string uf)
    {
        ...
        string googleCoordenadasURI = ConfigurationManager.AppSettings["sensedia.ws.coordenadas"] + queryString;

        JavaScriptSerializer js = new JavaScriptSerializer();
        var req = WebRequest.Create(ConfigurationManager.AppSettings["ws.AccessToken"]) as HttpWebRequest;
        ...
        request.Headers.Add("client_id", ConfigurationManager.AppSettings["sensedia.client.id"]);
        request.Headers.Add("access_token", js.DeserializeObject(result).ToString());
