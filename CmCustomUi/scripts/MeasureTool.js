...
var Config = exports.Config = {
  prefix: "measure-tool",
  tooltipText1: 'Arraste para modificar, click para remover',
  tooltipText2: 'Arraste para modificar'
};
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _init() {
      if (this._options.contextMenu) {
        ...
        this._startElementNode = this._contextMenu.addItem("Medir distância", true, this.start, this);
        this._endElementNode = this._contextMenu.addItem("Limpar medição", false, this.end, this);
